...
class TestRiskManager(unittest.TestCase):
    ...
    def test_should_have_per_position_short_limit(self):
        self.assertIsNotNone(CcyExposureLimitRiskEvaluator('BC').ccy_limits_short)
