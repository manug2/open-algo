...
class TestNonBlockingScenarios(unittest.TestCase):
...
class TestBlockingScenarios(unittest.TestCase):
    ...
    def test_should_log_journal_when_first_consumer_is_full(self):
        ...
        cons2 = Queue()
        self.consumer_queues.append(cons2)
        self.spmc_q.add_consumer(cons2, timeout=0.1)
